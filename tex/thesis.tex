...
\include{chapters/02_review}
\include{chapters/03_model}
\include{chapters/04_theorem}
\include{chapters/05_algorithm}
\include{chapters/06_simulation}
\include{chapters/07_experiment}
\include{chapters/08_conclusion}

% --- Список литературы ---
% На этапе скелета (M1) включаем все источники из bib через \nocite{*},
% чтобы валидировать работу biblatex-gost. На M2 при наполнении глав
% эту строку нужно удалить — список будет формироваться только из \cite-вых.
\nocite{*}
