...
$K_{\mathrm{lower}}$, калиброванной по симуляции
($\approx 0{,}012$~мДж на единицу~$G$, см. \S\ref{sec:simulation-pareto}).
Это даёт универсальный <<пол>> кривой $E^{*}(G^{*})$: ни одна точка фронта не
может лежать ниже прямой $E = K_{\mathrm{lower}} \cdot G$. Сравнение полученного
