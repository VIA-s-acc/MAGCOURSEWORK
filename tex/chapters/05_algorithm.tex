...
поиска от континуума до конечного множества кандидатов и позволяет
конструктивно построить полную Парето-границу задачи многокритериальной
оптимизации обновления EPD-панели.
...
$K_{\mathrm{eff}}^{*}$ нового оптимума~--- прямое следствие включения множеств
...
$8 \times 8$~--- около $2 \cdot 10^5$ вызовов, что при дешёвой модели $\widehat{F}$
